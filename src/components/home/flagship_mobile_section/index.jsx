    ...
    return (
        <div className={styles.container}>
            ...
            <swiper-container className="mySwiper" navigation="true" slides-per-view={isSM ? "1" : isMaxMD ? "3" : "4"}
                ...
                <swiper-slide>
                    <ProductTemplate title={`گوشی سامسونگ s23 اولترا 256گیگ حافظه و 12گیگ RAM`} price={"100000000"} offer={0} id={`ksdksk`} cover={"anh-nhat-yqcloMb3Abw-unsplash_prev_ui.png"} />
                </swiper-slide>
                <swiper-slide>
